...
sprites.onDestroyed(SpriteKind.tnt, function (sprite) {
    ...
    BOOOM = sprites.create(img`
        ...
        . 4 4 . . . . . . . . . . 4 4 . 
        `, SpriteKind.boom)
    BOOOM.changeScale(2, ScaleAnchor.Middle)
    BOOOM.setPosition(sprite.x, sprite.y)
    BOOOM.lifespan = 500
    TriggerBlast()
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile1`, function (sprite, location) {
    if (HasFlintAndSteel) {
        ...
        TNT = sprites.create(assets.image`myImage3`, SpriteKind.tnt)
        TNT.lifespan = 3000
        ...
        tiles.placeOnTile(TNT, location)
    }
})
...
function SpawnTresure () {
    halo = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . b d b . . . . . . 
        . . . . . . . b d b c . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.na)
    halo.changeScale(1.5, ScaleAnchor.Middle)
    tiles.placeOnTile(halo, tiles.getTileLocation(47, 13))
    halo.lifespan = 1000
    treasure = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.na)
    tiles.placeOnTile(treasure, tiles.getTileLocation(47, 13))
    treasure.follow(MyPlayer, 100)
}
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (isMovieOver) {
        if (MyPlayer.isHittingTile(CollisionDirection.Bottom) || IsOnLader) {
            music.play(music.melodyPlayable(music.thump), music.PlaybackMode.InBackground)
            MyPlayer.vy += -150
        }
    }
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Laters, function (sprite, otherSprite) {
    sprites.destroy(otherSprite)
    MakeLader()
})
function MakeLader () {
    ...
    while (LadderLoop > 0) {
        if (true) {
            tiles.setTileAt(tiles.getTileLocation(2, LadderLoop), assets.tile`Lader`)
            music.play(music.melodyPlayable(music.knock), music.PlaybackMode.UntilDone)
            LadderLoop += -1
            tempNum += -1
            pause(100)
...
function TriggerBlast () {
    ...
    tiles.setTileAt(tiles.getTileLocation(42, 13), assets.tile`myTile0`)
    tiles.setTileAt(tiles.getTileLocation(42, 14), assets.tile`myTile0`)
    tiles.setTileAt(tiles.getTileLocation(44, 15), assets.tile`LightBlastfloor0`)
    tiles.setTileAt(tiles.getTileLocation(43, 15), assets.tile`HevyBlastfloor0`)
    tiles.setTileAt(tiles.getTileLocation(42, 15), assets.tile`myTile2`)
    tiles.setTileAt(tiles.getTileLocation(41, 15), assets.tile`HevyBlastfloor`)
    tiles.setTileAt(tiles.getTileLocation(40, 15), assets.tile`LightBlastfloor`)
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.lighter, function (sprite, otherSprite) {
    sprites.destroy(otherSprite)
...
function MakeBridge () {
    ...
    while (Bridgeloop > 0) {
        if (true) {
            tiles.setWallAt(tiles.getTileLocation(bridgePos, 12), true)
            tiles.setTileAt(tiles.getTileLocation(bridgePos, 12), assets.tile`Dirt`)
            music.play(music.melodyPlayable(music.knock), music.PlaybackMode.UntilDone)
            bridgePos += 1
            Bridgeloop += -1
            pause(500)
...
function PlaceLadder () {
    ladder = sprites.create(assets.image`myLader`, SpriteKind.Laters)
    tiles.placeOnTile(ladder, tiles.getTileLocation(2, 14))
}
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`Lader`, function (sprite, location) {
    IsOnLader = true
})
function MakePlayer () {
...
function Level_3_items () {
    shovel = sprites.create(assets.image`Shovle`, SpriteKind.tool)
    tiles.placeOnTile(shovel, tiles.getTileLocation(0, 14))
    shovel = sprites.create(assets.image`FlintAndSteel`, SpriteKind.lighter)
    tiles.placeOnTile(shovel, tiles.getTileLocation(29, 3))
}
